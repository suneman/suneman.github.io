---
title: "Master's Defense Notes"
date: 2014-08-04 18:37:15
slug: "masters-defence-notes"
status: publish
author: "sunelehmann"
original_url: "https://sunelehmann.com/masters-defence-notes/"
---
...
We begin stage 2 with a short round of simple questions about the basic methodology of your thesis. What does this model actually do? Why this statistical test and not some other one? What is on the axes in Figure 4? Why this dataset? These questions are not designed to be difficult, and if you've done the work, they'll be over quickly.

The reason we ask them is that we live in the age of agentic AI. It has become entirely possible to hand in a thesis containing methods that no human in the room fully understands – and part of our job is to establish that you are not one of those humans. Use whatever tools you like while working (we do too), but the methodology has to be *yours* in the sense that you can explain and justify every choice in it without notes.
...
In order to get ready for all this, one recommendation is to re-read your thesis from a self-critical perspective before the defense. That way you'll be able to discuss the weaknesses identified up front - rather than try to sweep them under the rug. It's ok to have weaknesses if you are aware of them. (And we'll be able to see right through your attempts anyway).
